...
- **Hierarchical temporal modeling**: separating stable persona traits from dynamic session states to reduce persona variance
- **Action and rationale prediction**: predicting both what users do and why (a new evaluation dimension)
